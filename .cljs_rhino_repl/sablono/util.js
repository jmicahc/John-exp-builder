...
var x__15934__auto__ = (((x == null))?null:x);
var m__15935__auto__ = (sablono.util.to_str[goog.typeOf(x__15934__auto__)]);
if(!((m__15935__auto__ == null))){
return m__15935__auto__.call(null,x);
} else {
var m__15935__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__15935__auto____$1 == null))){
return m__15935__auto____$1.call(null,x);
} else {
...
var x__15934__auto__ = (((x == null))?null:x);
var m__15935__auto__ = (sablono.util.to_uri[goog.typeOf(x__15934__auto__)]);
if(!((m__15935__auto__ == null))){
return m__15935__auto__.call(null,x);
} else {
var m__15935__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__15935__auto____$1 == null))){
return m__15935__auto____$1.call(null,x);
} else {
...
var len__16337__auto___29606 = arguments.length;
var i__16338__auto___29607 = (0);
while(true){
if((i__16338__auto___29607 < len__16337__auto___29606)){
args__16344__auto__.push((arguments[i__16338__auto___29607]));

var G__29608 = (i__16338__auto___29607 + (1));
i__16338__auto___29607 = G__29608;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__16345__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq29605){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29605));
});
/**
...
var vec__29610 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__29610,(0),null);
var words = cljs.core.nthnext.call(null,vec__29610,(1));
...
var G__29612 = clojure.set.rename_keys.call(null,m,kmap);
var G__29612__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__29612,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__29612);
return G__29612__$1;
} else {
return m;
}
...
var args__16344__auto__ = [];
var len__16337__auto___29615 = arguments.length;
var i__16338__auto___29616 = (0);
while(true){
if((i__16338__auto___29616 < len__16337__auto___29615)){
args__16344__auto__.push((arguments[i__16338__auto___29616]));

var G__29617 = (i__16338__auto___29616 + (1));
i__16338__auto___29616 = G__29617;
continue;
} else {
}
break;
...
var argseq__16345__auto__ = ((((0) < args__16344__auto__.length))?(new cljs.core.IndexedSeq(args__16344__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__16345__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__29613_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__29613_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__29613_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__29613_SHARP_)){
return p1__29613_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__29613_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq29614){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29614));
});
/**
...
var vec__29621 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__29621,(0),null);
var names = cljs.core.nth.call(null,vec__29621,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__29621,tag_name,names){
return (function (p1__29618_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__29618_SHARP_));
});})(matches,vec__29621,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__29621,tag_name,names){
return (function (p1__29619_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__29619_SHARP_));
});})(matches,vec__29621,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_children = (function sablono$util$normalize_children(x){
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__29622){
var vec__29625 = p__29622;
var tag = cljs.core.nth.call(null,vec__29625,(0),null);
var content = cljs.core.nthnext.call(null,vec__29625,(1));
...
var vec__29626 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__29626,(0),null);
var id = cljs.core.nth.call(null,vec__29626,(1),null);
var class$ = cljs.core.nth.call(null,vec__29626,(2),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag__$1,sablono.util.merge_with_class.call(null,tag_attrs,map_attrs),sablono.util.normalize_children.call(null,cljs.core.next.call(null,content))], null);
} else {
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag__$1,tag_attrs,sablono.util.normalize_children.call(null,content)], null);
}
});
/**
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__15279__auto__ = x__$1.hasDomain();
